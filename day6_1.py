...
if __name__ == '__main__':
    ...
    # Create a grid showing which coordinate is closest to each point
    GRID = Grid.manhattan_grid(COORDINATES)
    # Create a list of finite-area coordinates
    FINITE_COORDINATES = GRID.get_finite_coordinates(COORDINATES)
    # Determine which finitely bound coordinate encapsulates the largest area
    print(str(GRID.largest_bound_area(FINITE_COORDINATES)))
